 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://ejs.com/", wsdlLocation = "http://localhost:8080/wsPrueba/bicicletas?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://ejs.com/", "ServiceService");
    ...
    public com.ejs.Service getServicePort() {
        return super.getPort(new QName("http://ejs.com/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public com.ejs.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ejs.com/", "ServicePort"), Service.class, features);
    }
